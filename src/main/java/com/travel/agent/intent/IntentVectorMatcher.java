package com.travel.agent.intent;
 ...
 * {@link com.travel.config.IntentRouterKnowledgeConfig}）执行 Top-1 检索。
 ...
 * bean 注册在 {@link com.travel.config.IntentRouterKnowledgeConfig} 中完成。</p>
 *
 * @author Hollis
 */
